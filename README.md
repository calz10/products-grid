...
### How do I start the app?
 ...
 - Start with `npm run build` to build the project. The server will look for any files you add to the `public/` directory.
 - `npm run start:dev` to run the project on debug mode
